HT.register({
  ...
  note: '원본 사이트는 금융감독원 금융상품통합비교공시(finlife.fss.or.kr) API를 서버에서 호출합니다. 이 API는 브라우저에서 직접 호출할 수 없어, 여기서는 상품을 직접 입력해 비교합니다. 예금 이자는 단리·만기 지급, 적금은 월초 납입 단리, 대출은 원리금균등 기준이며 이자소득세 15.4%를 뺀 세후 이자도 함께 보여줍니다. 예금자보호는 1인당 1금융기관 5,000만원까지입니다.',
  render(root) {
